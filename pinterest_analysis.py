...
from pinterest_models import BrainOutput, KeywordCandidate, PinRecord, SeedScrapeResult
...
def _load_prompt() -> str:
    prompt_path = Path(__file__).resolve().parent / "prompts" / "pinterest_analysis.md"
